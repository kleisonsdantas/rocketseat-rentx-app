...
export const LogoutButton = styled(BorderlessButton as unknown as AnyStyledComponent)``;
...
export const PhotoButton = styled(RectButton as unknown as AnyStyledComponent)`
  width: 40px;
  height: 40px;
